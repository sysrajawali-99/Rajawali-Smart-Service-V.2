...
export const WeeklyActivityView: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-7xl mx-auto">
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-start gap-2.5">
                      <span className="shrink-0 inline-flex items-center justify-center w-7 h-7 rounded-lg bg-purple-100 text-purple-800 border border-purple-300 font-black text-xs">
                        W
                      </span>
                      <div>
                        <div className="flex items-center gap-1.5 text-slate-400 text-xs font-semibold">
                          <span>#{index + 1}</span>
                          <span>·</span>
                          <span className="text-purple-700 font-bold">Weekly Activity</span>
                        </div>
                          ...
                          return (
                            <button
                              ...
                              className={`h-9 rounded-lg text-xs font-black transition-all flex flex-col items-center justify-center ${
                                isCurrent
                                  ? `${meta.badgeClass} ring-2 ring-purple-400 shadow-xs scale-102`
                  ...
                  {/* Expandable Week / Month Days Matrix for this Task */}
                  <div className="pt-1">
                    <button
                      type="button"
                    ...
                    >
                      <span className="flex items-center gap-1.5">
                        <Calendar className="w-3.5 h-3.5 text-purple-600" />
                        <span>Siklus Hari Minggu Ini & Sebulan</span>
                      </span>
                      <div className="flex items-center gap-1">
      ...
      {/* ============================================================ */}
      {/* 2. VIEW MODE: TABEL SIKLUS MINGGUAN                          */}
      {/* ============================================================ */}
      {viewMode === 'table' && (
        <div className="space-y-3">
          {/* Mobile swipe helper */}
          <div className="md:hidden flex items-center justify-between gap-2 p-3 bg-purple-50 border border-purple-200 rounded-xl text-xs text-purple-900 shadow-2xs">
            <div className="flex items-center gap-2">
              <Smartphone className="w-4 h-4 text-purple-600 shrink-0" />
              <span className="text-[11px] leading-tight">
                Tabel lebar siklus mingguan: Geser ke samping, atau gunakan <strong>Kartu Tugas</strong> untuk tampilan ramah layar ponsel.
              </span>
            </div>
            <button
              type="button"
              onClick={() => setViewMode('cards')}
              className="shrink-0 px-2.5 py-1.5 bg-purple-700 hover:bg-purple-800 text-white font-bold rounded-lg text-[11px] shadow-xs"
            >
              Mode Kartu
            </button>
          </div>
