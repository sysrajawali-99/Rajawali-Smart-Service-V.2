      ...
      {isAddModalOpen && (
        ...
        >
          <div
            ...
            className="bg-white w-full max-w-2xl rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200 overflow-hidden my-auto max-h-[92dvh] flex flex-col overscroll-contain animate-in zoom-in-95 duration-200"
          >
            {/* Modal Header */}
            <div className="p-4 sm:p-5 border-b border-slate-100 bg-slate-50/70 flex items-center justify-between gap-2 shrink-0">
              ...
              <button
                ...
                type="button"
                onClick={() => setIsAddModalOpen(false)}
                aria-label="Tutup Master Cleaning Program"
            ...
            {/* Modal Form */}
            <form onSubmit={handleSaveProgram} className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1 overscroll-contain">
              {/* Uraian Pekerjaan */}
              <div>
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2">
                <button
                  id="cancel-mcp-modal-btn"
                  type="button"
                  onClick={() => setIsAddModalOpen(false)}
                  className="px-5 py-2.5 rounded-xl border border-slate-200 text-slate-700 text-xs font-semibold hover:bg-slate-100 active:bg-slate-200 min-h-[44px] flex items-center justify-center cursor-pointer transition-colors"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white text-xs font-semibold shadow-xs min-h-[44px] flex items-center justify-center cursor-pointer transition-colors"
                >
